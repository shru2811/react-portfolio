...
function Projects() {
  ...
  return (
    <div className="container mx-auto px-4 py-8 animate-slide-in-top">
      <h1 className="text-5xl font-bold text-indigo-200 2xl:text-7xl text-center mb-4">Projects</h1>
      <p className="text-xl text-gray-500 mt-3 text-gray-300 2xl:text-3xl text-center mb-16">From Concept to Creation: My Work Showcase</p>
